        ...
        $("#fileInputImage").on('change', function () {
            ...
            $.ajax({
                ...
                success: function (path) {
                    $('#txtImage').val(path);
                    lehieu.notify('Upload image succesful!', 'success');

                },
                error: function () {
                    lehieu.notify('There was error uploading files!', 'error');
                }
            });
        });
        ...
        $('body').on('click', '#btnDelete', function (e) {
            ...
            lehieu.confirm('Are you sure to delete?', function () {
                $.ajax({
                    ...
                    success: function (response) {
                        lehieu.notify('Deleted success', 'success');
                        lehieu.stopLoading();
                        loadData();
                    },
                    error: function (status) {
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        lehieu.notify('Update success', 'success');
                    ...
                    error: function () {
                        lehieu.notify('Has an error in update progress', 'error');
                        lehieu.stopLoading();
                    }
                });
            }
    ...
    function initTreeDropDownCategory(selectedId) {
        $.ajax({
            ...
            success: function (response) {
                ...
                var arr = lehieu.unflattern(data);
    ...
    function loadData() {
        $.ajax({
            ...
            success: function (response) {
                ...
                var treeArr = lehieu.unflattern(data);
