    ...
    function saveProduct() {
        if ($('#frmMaintainance').valid()) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    lehieu.notify('Update product successful', 'success');
                ...
                error: function () {
                    lehieu.notify('Has an error in save product progress', 'error');
                    lehieu.stopLoading();
                }
            });
            return false;
        ...
        lehieu.confirm('Are you sure to delete?', function () {
            $.ajax({
                ...
                error: function (status) {
                    lehieu.notify('Has an error in delete progress', 'error');
                    lehieu.stopLoading();
                }
            });
        });
